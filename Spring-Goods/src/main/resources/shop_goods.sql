...
CREATE TABLE `tb_brand` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1128662123111649281 DEFAULT CHARSET=utf8 COMMENT='品牌表，一个品牌下有多个商品（spu），一对多关系';
...
INSERT INTO `tb_brand` VALUES ('1113454954108030976', 'TTTT', '', 'T');
INSERT INTO `tb_brand` VALUES ('1115231159689809920', 'Test', '', 'T');
INSERT INTO `tb_brand` VALUES ('1115231592562954240', 'Testuuu', '', 'T');
INSERT INTO `tb_brand` VALUES ('1128662090123448320', 'Test', '', 'T');
INSERT INTO `tb_brand` VALUES ('1128662123111649280', 'Test', '', 'T');
